...
## Authors: (Team 25)
- Amy Vu (av24089)
- Mia Martinez (mm14759)
- Joshua Mark (jcm68203)
- Sasha Park (sp98996)
- Adiva Parisa (akp90394)
...
> [!NOTE] Disclaimer for Testing: <br/>
...
- Created `README.md` and `How_To_Use_Github.md`
- Finalized testing, final edits, and submitted the project to elc.
- **Query: "The name and IDs of students who are advised by the Instructor, Mird"**
### Sasha Park
- Implemented the team's queries in `Driver.java`
- Tweeked the natural join() implementation in `RAImpl.java` that was made by Mia.
